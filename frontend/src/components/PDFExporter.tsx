  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full py-3 px-6 bg-brand-600 text-white font-semibold rounded-lg hover:bg-brand-700 transition-colors flex items-center justify-center gap-2"
      >
