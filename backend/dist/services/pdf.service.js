...
async function generateBarcodePNG(value, format) {
...
async function generateQRPNG(value, sizeMm) {
        ...
        for (const element of template.elements) {
            ...
            if (element.type === 'text') {
                ...
                if (element.rotation) {
                    ...
                    doc.setCurrentTransformationMatrix(doc.Matrix(1, 0, 0, 1, elX + elWidth / 2, elY + elHeight / 2));
                    doc.setCurrentTransformationMatrix(doc.Matrix(Math.cos(element.rotation * Math.PI / 180), Math.sin(element.rotation * Math.PI / 180), -Math.sin(element.rotation * Math.PI / 180), Math.cos(element.rotation * Math.PI / 180), 0, 0));
