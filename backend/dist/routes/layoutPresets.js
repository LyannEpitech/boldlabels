...
export function createLayoutPresetRoutes(prisma) {
    ...
    router.post('/', async (req, res) => {
        try {
            const { name, templateId, pageSize, orientation, marginTop, marginRight, marginBottom, marginLeft, labelsPerRow, labelsPerColumn, horizontalSpacing, verticalSpacing, isDefault, } = req.body;
    ...
    router.put('/:id', async (req, res) => {
        try {
            const { name, pageSize, orientation, marginTop, marginRight, marginBottom, marginLeft, labelsPerRow, labelsPerColumn, horizontalSpacing, verticalSpacing, isDefault, } = req.body;
