...
const router = Router();
export function createSessionDataRoutes(prisma) {
    ...
    router.put('/:templateId', async (req, res) => {
        try {
            const { csvHeaders, csvRows, pageSize, orientation, marginTop, marginRight, marginBottom, marginLeft, labelsPerRow, labelsPerColumn, horizontalSpacing, verticalSpacing, selectedMappingId, } = req.body;
